...
#define CLIENT_DEVICE_UTC_OFFSET "+00:00"
#define CLIENT_DEVICE_TIMEZONE "Europe/Paris"
...
static char utc_offset[UTC_OFFSET_STR_LEN] = CLIENT_DEVICE_UTC_OFFSET;
static char timezone[TIMEZONE_STR_LEN] = CLIENT_DEVICE_TIMEZONE;
