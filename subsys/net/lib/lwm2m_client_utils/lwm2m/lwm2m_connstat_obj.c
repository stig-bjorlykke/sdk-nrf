				       ...
				       uint16_t res_inst_id, size_t *data_len)
{
	...
	err = lwm2m_get_res_buf(&LWM2M_OBJ(LWM2M_OBJECT_CONNECTIVITY_STATISTICS_ID,
					   obj_inst_id, res_id), &data, NULL, NULL, NULL);
	if (err) {
...
{
	/* create object */
	lwm2m_create_object_inst(&LWM2M_OBJ(LWM2M_OBJECT_CONNECTIVITY_STATISTICS_ID, 0));
	lwm2m_register_read_callback(&LWM2M_OBJ(LWM2M_OBJECT_CONNECTIVITY_STATISTICS_ID, 0,
						CONNSTAT_SMS_TX_COUNTER_ID),
				     connstat_resource_read_cb);
	lwm2m_register_read_callback(&LWM2M_OBJ(LWM2M_OBJECT_CONNECTIVITY_STATISTICS_ID, 0,
						CONNSTAT_SMS_RX_COUNTER_ID),
				     connstat_resource_read_cb);
	lwm2m_register_read_callback(&LWM2M_OBJ(LWM2M_OBJECT_CONNECTIVITY_STATISTICS_ID, 0,
						CONNSTAT_TX_DATA_ID), connstat_resource_read_cb);
	lwm2m_register_read_callback(&LWM2M_OBJ(LWM2M_OBJECT_CONNECTIVITY_STATISTICS_ID, 0,
						CONNSTAT_RX_DATA_ID), connstat_resource_read_cb);
	lwm2m_register_read_callback(&LWM2M_OBJ(LWM2M_OBJECT_CONNECTIVITY_STATISTICS_ID, 0,
						CONNSTAT_MAX_MSG_SIZE_ID),
				     connstat_resource_read_cb);
	lwm2m_register_exec_callback(&LWM2M_OBJ(LWM2M_OBJECT_CONNECTIVITY_STATISTICS_ID, 0,
						CONNSTAT_START_ID), lwm2m_connstat_start_cb);
	lwm2m_register_exec_callback(&LWM2M_OBJ(LWM2M_OBJECT_CONNECTIVITY_STATISTICS_ID, 0,
						CONNSTAT_STOP_ID), lwm2m_connstat_stop_cb);

	lwm2m_register_read_callback(&LWM2M_OBJ(LWM2M_OBJECT_CONNECTIVITY_STATISTICS_ID, 0,
						CONNSTAT_AVG_MSG_SIZE_ID),
				     connstat_resource_read_cb);
